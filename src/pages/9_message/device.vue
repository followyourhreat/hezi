<template>
  <div>
    <div class="dt-search-top">
      <div class="dt-search-cells">
        <div class="dt-search-cell">
          <Input v-model="params.keyword" class="dt-search-input" placeholder="请输入消息内容查询"/>
        </div>
        <div class="dt-search-cell">
    ...
    <dt-table ref="table" url="devicepush/list" :params="params" :columns="columns"></dt-table>
...
export default {
            ...
            return h("div", [
              ...
              h(
                "span",
                {
                  ...
                  on: {
                    click: () => {
                      this.handleRemove("devicepush/del", {
                        id: params.row.id
                      });
                    }
                  }
  ...
  methods: {
    handleStatus(item) {
      this.$post("devicepush/push", { id: item.id }).then(res => {
        this.handleSearch();
      });
    },
    handleAdd() {
